...
private:
  ...
  void removeWires(uint32 maxWireWidth);
  void evaluateIsland(uint16 islandIntensity, uint16 checkedIslandIntensity, float prctCloseToCircle);
  void evaluateHole(uint16 holeIntensity, uint16 allowedMargin);
