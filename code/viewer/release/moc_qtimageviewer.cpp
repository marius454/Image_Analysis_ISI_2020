...
QT_MOC_LITERAL(4, 33, 9), // "directory"
QT_MOC_LITERAL(5, 43, 6), // "Image*"
QT_MOC_LITERAL(6, 50, 7), // "myImage"
QT_MOC_LITERAL(7, 58, 8), // "openFile"
QT_MOC_LITERAL(8, 67, 4) // "quit"

    },
    "QtImageViewer\0showFile\0\0filename\0"
    "directory\0Image*\0myImage\0openFile\0"
    "quit"
};
...
void QtImageViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->showFile((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< short(*)>(_a[2]))); break;
        case 1: _t->showFile((*reinterpret_cast< Image*(*)>(_a[1]))); break;
